...
class ItemRequestRepositoryTest {
    ...
    void findByRequesterIdTest() {
        Page<ItemRequest> requests = itemRequestRepository.findAllByRequesterId(requester1.getId(), Pageable.unpaged());

        assertThat(requests, hasItems());
        assertThat(requests.toList().size(), equalTo(2));
        assertThat(requests.toList(), equalTo(List.of(itemRequest1, itemRequest2)));
    }
}